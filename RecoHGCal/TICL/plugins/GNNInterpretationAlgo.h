...
namespace ticl {
  ...
  struct GraphEdge {
    ...
    float weight;           // Optional: distance, similarity, or energy
  };
  ...
  private:
    ...
    void constructNodeFromWindow(const MultiVectorManager<Trackster> &tracksters,
    ...
    const size_t track_block_size     = 16; // number of track features
